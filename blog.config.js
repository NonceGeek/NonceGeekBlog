...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NonceGeekDAO', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '全球性的 IndieHacker Dev DAO', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/noncegeek', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, DAO', // 网站关键词 英文逗号隔开
